...
function declareFoodPreference() {
  if (isFavorite == true) {
...
var vegetables = ["peas", "carrots", "cabbage", "celery", "onions"];
...
// different fruits.
var fruits = ["peaches", "tangerines", "plums", "kiwi", "strawberries", "mangos", "bananas"];
